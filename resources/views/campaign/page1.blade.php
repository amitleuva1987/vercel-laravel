...
<div class="containerWrapper">
  <style id="globalHeadlineCSS" data-font-fam="Montserrat">
          ...
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            <div class="de elHeadlineWrapper ui-droppable de-editable" id="headline-45511" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 30px; outline: none; cursor: pointer; font-family: Oswald, Helvetica, sans-serif !important;" aria-disabled="false" data-google-font="Oswald">
              <h1 class="ne elHeadline hsSize3 elMargin0 elBGStyle0 hsTextShadow0 lh1 mfs_22" style="text-align: center; font-size: 34px; color: rgb(45, 45, 45);" data-bold="inherit" data-gramm="false" contenteditable="false">
                <b>FILL OUT YOUR DETAILS TO GET ACCESS NOW 1!</b>
              </h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="de elHeadlineWrapper ui-droppable de-editable" id="headline-91347" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 35px; outline: none; cursor: pointer; font-family: Oswald, Helvetica, sans-serif !important;" aria-disabled="false" data-google-font="Oswald">
              <h1 class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0 deNormalLS mfs_16" style="text-align: center; font-size: 14px; color: rgb(45, 45, 45);" data-bold="inherit" data-gramm="false" contenteditable="false">
                <i class="fa_prepended fas fa-lock" contenteditable="false"></i> Your information is 100% secure
              </h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="de ui-droppable de-editable" id="headline-72831" data-de-type="headline" data-de-editing="false" data-title="cf-show-on-step-1" data-ce="true" data-trigger="ran" data-animate="top" data-delay="500" style="outline: none; cursor: pointer; margin-top: 10px; opacity: 1; position: relative; top: 0px;" aria-disabled="false">
              <div class="ne elHeadline elMargin0 elBGStyle0 hsTextShadow0 hsSize4 lh1 deneg1pxLetterSpacing" style="text-align: center; color: rgb(45, 45, 45); font-size: 32px;" data-bold="inherit" contenteditable="false">
                <b>Step #1 - </b>Where Should We Ship Your FREE Book?
              </div>
            </div>
            ...
            <div class="de ui-droppable de-editable" id="headline-85365" data-de-type="headline" data-de-editing="false" data-title="cf-show-on-step-2" data-ce="true" data-trigger="ran" data-animate="top" data-delay="500" style="outline: none; cursor: pointer; margin-top: 10px; display: none; opacity: 1; position: relative; top: 0px;" aria-disabled="false">
              <div class="ne elHeadline elMargin0 elBGStyle0 hsTextShadow0 hsSize4 lh1 deneg1pxLetterSpacing" style="text-align: center; color: rgb(45, 45, 45); font-size: 32px;" data-bold="inherit" contenteditable="false">
                <b>Step #2 </b>- Your FINAL Step To Get Your FREE Book
              </div>
            </div>
            ...
            <div class="de elMargin0 elOrder2Step ui-droppable de-editable" id="tmp_order2stepi-58237" data-de-type="order2stepi" data-de-editing="false" data-title="Order 2 Step" data-ce="false" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: -20px; outline: none; cursor: pointer;" aria-disabled="false" data-translates2="s2translate" data-translates1="xXxx">
              <div class="o2step_step1 o2step_wrapper drpZone" style="">
                ...
                <div class="elOS1Shipping">
                  ...
                  <select name="shipping_country" class="elInput elInput100 elAlign_left elInputSmall elInputBG1 elInputBR5 elInputI0 elInputIBlack elInputIRight required1 elInputSmall elInputBG2 inputOverLabel elInputStyl0 garlic-auto-save" data-type="extra" style="clear: left;" required="" id="input-26428">
              ...
              <div class="o2step_step2 o2step_wrapper drpZone" style="display: none;">
                ...
                <div class="elOrderProductOptions" data-de-type="orpo">
                  ...
                  <div class="clearfix elOrderProductOptinProducts" data-cf-product-template="true">
                    <div class="pull-left elOrderProductOptinProductName"> <input type="radio" id="lbl-01" name="purchase[product_id]" value="">
                      <div class="pull-right elOrderProductOptinPrice" data-cf-product-price="true">$0.00</div> <label for="lbl-01" data-cf-product-name="true">Dynamically Updated</label>
                      <div class="elOrderProdInvDesc"></div>
                    </div>
                  </div>
                </div>
                <a id="order"></a>
                ...
                <div class="elCreditCardForm clearfix" style="margin-top:20px;">
                  ...
                  <div class="ccStripeElementCard elInputBR2">
                    ...
                    <div id="card-number-element" class="StripeElement StripeElement--empty elInputBR5 elInputStyl0 elInputBG2" style="width: 100%; margin-bottom: 8px; padding: 14px 18px; border: 1px solid rgba(0, 0, 0, 0.2);">
                  ...
                  <div class="ccStripeElementExp">
                    ...
                    <div id="card-exp-element" class="StripeElement StripeElement--empty elInputBR5 elInputStyl0 elInputBG2" style="width: calc(100% - 4px); margin-left: 4px; padding: 14px 18px; border: 1px solid rgba(0, 0, 0, 0.2);">
                      <div class="__PrivateStripeElement" style="margin: 0px !important; padding: 0px !important; border: none !important; display: block !important; background: transparent !important; position: relative !important; opacity: 1 !important;">
                  ...
                  <div class="ccStripeElementCVC">
                    ...
                    <div id="card-cvc-element" class="StripeElement StripeElement--empty elInputBR5 elInputStyl0 elInputBG2" style="width: calc(100% - 4px); margin-right: 4px; padding: 14px 18px; border: 1px solid rgba(0, 0, 0, 0.2);">
                      <div class="__PrivateStripeElement" style="margin: 0px !important; padding: 0px !important; border: none !important; display: block !important; background: transparent !important; position: relative !important; opacity: 1 !important;">
                    ...
                    <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                      <div class="de elBullet elMargin0 ui-droppable de-editable" id="list-67423" data-de-type="list" data-de-editing="false" data-title="icon bullet list" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" data-gramm="false" style="margin-top: 5px; outline: none; cursor: pointer;" aria-disabled="false">
                        <ul class="ne elBulletList elBulletListNew elBulletList2 listBorder0" data-bold="inherit" data-gramm="false" contenteditable="false" style="text-align: left;">
                          <li>
                            <i contenteditable="false" class="fa-fw far fa-check-circle" style="color: rgb(0, 189, 57);"></i><b>Audiobook: </b>Upgrade and <b>get immediate access</b> to the audiobook (read by Russell Brunson) for just one payment of $37.
                          </li>
                          <li>
                            <i contenteditable="false" class="fa-fw far fa-check-circle" style="color: rgb(0, 189, 57);"></i><b>​Funnel Catcher Report</b> - All the things you do BEFORE they get into your funnel.
                          </li>
                          <li>
                    ...
                    <div class="text-center" style="text-align: center;">
                      <p style="text-align: left" data-cf-id="order-bump" data-cf-note="orderform bump" data-cf-editable-type="rich-text">
                        <font size="2">
                          ...
                          <span class="otoText2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut, quod hic expedita consectetur vitae nulla sint adipisci cupiditate at. Commodi, dolore hic eaque tempora a repudiandae obcaecati deleniti mollitia possimus.</span>
                        </font>
                      </p>
                    </div>
                  </div>
...
' data-displaytype="htmlregular"></div>
                  ...
                  <div class="sectioncontent">
                    <div style="padding: 1px 10px; margin-bottom: 10px; background-color: rgb(186, 241, 202); text-align: center;">
                      ...
                      <label class="checkbox inline" style="font-weight: normal; line-height: 20px; display: inline-block; min-height: 20px; vertical-align: middle; margin-bottom: 0px; padding-left: 0px; padding-top: 5px"><b style="color: rgb(0, 153, 0); line-height: 30px">
                          <font size="4" class="bumpHeadline" data-cf-id="bump-headline" data-cf-note="bump headline" data-cf-editable-type="rich-text" style="font-size: 24px;">Yes, Russell! I Want The Audio Book (And Exclusive Bonuses) For Just $37!</font>
                        </b>
                      </label>
                    </div>
                    <div class="text-center" style="text-align: center;">
                      <p style="text-align: left" data-cf-id="order-bump" data-cf-note="orderform bump" data-cf-editable-type="rich-text">
                        <font size="2" style="font-size: 16px;"><u>
                            <font color="#CC3300" style="font-size: 16px;"><b class="otoText">Special One Time Offer: Audiobook + 4 Exclusive Products!</b></font>
                          </u>: <span class="otoText2">Bump content here...</span></font>
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div id="col-full-116" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="1st column" style="outline: none;">
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="de elHeadlineWrapper ui-droppable de-editable" id="headline-40393" data-de-type="headline" data-de-editing="false" data-title="Paragraph" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 5px; outline: none; cursor: pointer;" aria-disabled="false">
              <div class="ne elHeadline hsSize1 lh5 elMargin0 elBGStyle0 hsTextShadow0" data-bold="inherit" style="text-align: left;" data-gramm="false" contenteditable="false">
                <div>Upgrade and get Immediate access to the audio book (read by Russell Brunson) for just one time payment of $37, and get these 4 bonses for FREE!</div>
              </div>
            </div>
            <div class="de elBullet elMargin0 ui-droppable de-editable" id="tmp_list-73029" data-de-type="list" data-de-editing="false" data-title="icon bullet list" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" data-gramm="false" style="margin-top: 15px; outline: none; cursor: pointer;" aria-disabled="false">
              <ul class="ne elBulletList elBulletListNew elBulletList2 listBorder0" data-bold="inherit" data-gramm="false" contenteditable="false" style="text-align: left;">
                <li>
                  <i contenteditable="false" class="fa fa-fw fa-check"></i>Funnel Catcher Report - All the things you do BEFORE they get into your funnel.
                </li>
                <li>
                ...
                <div class="dashed orderFormBump radius5 shadow0 borderLight" style="border: 3px dashed rgb(186, 241, 202); padding: 10px; background-color: rgb(217, 255, 228);">
                  <div class="sectioncontent">
                    <div style="padding: 1px 10px; margin-bottom: 10px; background-color: rgb(186, 241, 202); text-align: center;">
                      ...
                      <label class="checkbox inline" style="font-weight: normal; line-height: 20px; display: inline-block; min-height: 20px; vertical-align: middle; margin-bottom: 0px; padding-left: 0px; padding-top: 5px"><b style="color: rgb(0, 153, 0); line-height: 30px">
                          <font size="4" class="bumpHeadline" data-cf-id="bump-headline" data-cf-note="bump headline" data-cf-editable-type="rich-text" style="font-size: 22px;">Yes, Give Me Immediate Access To Traffic Secrets LIVE For An Additional $97</font>
                        </b>
                      </label>
                    </div>
                    <div class="text-center" style="text-align: center;">
                      <p style="text-align: left" data-cf-id="order-bump" data-cf-note="orderform bump" data-cf-editable-type="rich-text">
                        <font size="2" style="font-size: 16px;"><u>
                            <font color="#CC3300" style="font-size: 16px;"><b class="otoText">Exclusive Upgrade</b></font>
                          </u>: <span class="otoText2">Earlier this year, Russell did a private 2 day event called "Traffic Secrets LIVE" with his $25k per year students revealing dozens of never before seen Traffic Secrets. This course has been in the vault and never available to the public for any price... Because you are an owner of the new Traffic Secrets book, you now you now have a one time chance to own this course. For a one time payment of $97, we will add this course to your members area and give you immediate access today! (This offer is not available at ANY other time of place)</span></font>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            <div class="de ui-droppable de-editable" id="tmp_headline1-84982" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="ran" data-animate="top" data-delay="500" style="outline: none; cursor: pointer; opacity: 1; position: relative; top: 0px;" aria-disabled="false">
              <div class="ne elHeadline elMargin0 elBGStyle0 hsTextShadow0 hsSize4 lh1" style="text-align: center; color: rgb(45, 45, 45); font-size: 64px;" data-bold="inherit" contenteditable="false">
                <u style="font-weight: bold;">"Traffic Secrets: New FREE Book</u>
              </div>
            </div>
      ...
      <div class="row noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin bgNoRepeat" id="row--52118-185" data-trigger="none" data-animate="fade" data-delay="500" data-title="1 column row - Clone" style="padding: 10px 0px 0px; margin: 0px auto; outline: none; width: 91%; max-width: 100%;" data-hide-on="desktop">
        <div id="col-full-124-107" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="1st column" style="outline: none;">
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="alert alert-danger alert-dismissible fade show w-50 ml-auto mt-3 alert-custom" role="alert" style="margin-top:25px;">
              {{ Session::get('error') }}
  ...
  <div class="container fullContainer noTopMargin padding20-top padding20-bottom padding40H noBorder borderSolid border3px cornersAll radius0 shadow0 bgNoRepeat emptySection" id="section--95511" data-title="Section" data-block-color="0074C7" style="padding-top: 20px; padding-bottom: 20px; outline: none;display: none !important;" data-trigger="none" data-animate="fade" data-delay="500" data-hide-on="mobile">
    <div class="containerInner ui-sortable">
      <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" id="row--55677-148" data-trigger="none" data-animate="fade" data-delay="500" data-title="1 column row - Clone" style="padding: 20px 200px; margin: 0px; outline: none; display: block;" data-hide-on="">
          ...
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="de ui-droppable de-editable" id="headline-78728-114" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="ran" data-animate="top" data-delay="500" style="outline: none; cursor: pointer; margin-top: 10px; opacity: 1; position: relative; top: 0px;" aria-disabled="false">
              <div class="ne elHeadline elMargin0 elBGStyle0 hsTextShadow0 hsSize4 lh1 deneg1pxLetterSpacing mfs_25" style="text-align: center; color: rgb(45, 45, 45); font-size: 38px;" data-bold="inherit" contenteditable="false">
                <i>Traffic Secrets</i> Has Already Helped Countless People Around The World...
              </div>
            </div>
            <div class="de ui-droppable de-editable" id="headline-17685-117" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="ran" data-animate="top" data-delay="500" style="outline: none; cursor: pointer; margin-top: 5px; opacity: 1; position: relative; top: 0px;" aria-disabled="false">
              <div class="ne elHeadline elMargin0 elBGStyle0 hsTextShadow0 hsSize4 lh1 deneg1pxLetterSpacing mfs_20" style="text-align: center; color: rgb(45, 45, 45); font-size: 32px;" data-bold="inherit" contenteditable="false">
                <div><b>The Question Is, Are YOU Next?</b></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="col-full-125-183" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="1st column" style="outline: none;">
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
            ...
            <div class="de elHeadlineWrapper ui-droppable de-editable" id="headline-38987-185" data-de-type="headline" data-de-editing="false" data-title="sub-headline" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" data-gramm="false" style="margin-top: 0px; outline: none; cursor: pointer; display: block; font-family: Roboto, Helvetica, sans-serif !important;" aria-disabled="false" data-google-font="Roboto">
              <div class="ne elHeadline hsSize2 elMargin0 elBGStyle0 hsTextShadow0 deUppercase lh1 mfs_32" style="text-align: left; font-size: 50px;" data-bold="inherit" data-gramm="false" contenteditable="false">
                <div>
                  <font color="#2d2d2d"><b>Your address</b></font>
                </div>
              </div>
            </div>
  ...
  <div class="container fullContainer noTopMargin padding20-top padding20-bottom padding40H borderSolid cornersAll radius0 shadow0 bgNoRepeat emptySection borderLightTop border5px" id="section--39479" data-title="Section" data-block-color="0074C7" style="padding-top: 20px; padding-bottom: 20px; outline: none; background-color: rgb(16, 25, 39); margin-top: 50px; border-color: rgb(245, 60, 92);" data-trigger="none" data-animate="fade" data-delay="500">
    <div class="containerInner ui-sortable">
      <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" id="row-162" data-trigger="none" data-animate="fade" data-delay="500" data-title="1 column row" style="padding-top: 20px; padding-bottom: 20px; margin: 0px; outline: none;">
        <div id="col-full-103-149" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="1st column" style="outline: none;">
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
      ...
      <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" id="row-131" data-trigger="none" data-animate="fade" data-delay="500" data-title="1 column row" style="padding: 20px 0px; margin: 0px; outline: none;">
        <div id="col-full-129-130-100-125-112-187" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="1st column" style="outline: none;">
          <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
  ...
  <style id="bold_style_tmp_headline1-84982">
    #tmp_headline1-84982 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-57016">
    #headline-57016 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-33950">
    #headline-33950 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-67680">
    #headline-67680 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-69439">
    #headline-69439 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_button-50515">
    #button-50515 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-50515 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-50515 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-50515 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -ms-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: linear-gradient(to bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    }

    #button-50515 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -ms-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: linear-gradient(to bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    }

    #button-50515 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -ms-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: linear-gradient(to bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    }

    #button-50515 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -ms-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: linear-gradient(to bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    }

    #button-50515 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-50515 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-65506">
    #headline-65506 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-87778">
    #headline-87778 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-15790">
    #headline-15790 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-67680-104">
    #headline-67680-104 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-71668-183">
    #headline-71668-183 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-69439-170">
    #headline-69439-170 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-15790-144">
    #headline-15790-144 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-65506-118">
    #headline-65506-118 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-87778-134">
    #headline-87778-134 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_button-50515-169">
    #button-50515-169 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-50515-169 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-50515-169 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-50515-169 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-50515-169 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-50515-169 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #button-50515-169 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-50515-169 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-50515-169 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  ...
  <style id="bold_style_headline-30723">
    #headline-30723 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_button-60555">
    #button-60555 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-60555 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-60555 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-60555 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-60555 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-60555 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #button-60555 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-60555 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-60555 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_tmp_headline1-67396">
    #tmp_headline1-67396 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="bold_style_headline-67680-139">
    #headline-67680-139 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-71668-185">
    #headline-71668-185 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-38323">
    #headline-38323 .elHeadline b {
      color: rgb(67, 67, 67);
    }
  </style>
  <style id="bold_style_headline-58724">
    #headline-58724 .elHeadline b {
      color: rgb(67, 67, 67);
    }
  </style>
  <style id="bold_style_tmp_headline1-30217-150">
    #tmp_headline1-30217-150 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-64123-169">
    #headline-64123-169 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-96028-138">
    #headline-96028-138 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_tmp_headline1-30217-150-131">
    #tmp_headline1-30217-150-131 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-64123-169-132">
    #headline-64123-169-132 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-96028-138-189">
    #headline-96028-138-189 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-69439-103-176">
    #headline-69439-103-176 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-15790-110-122">
    #headline-15790-110-122 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-83405-174-114">
    #headline-83405-174-114 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-71635-148-137">
    #headline-71635-148-137 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="button_style_button-79521-154-104">
    #button-79521-154-104 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-79521-154-104 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-79521-154-104 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-79521-154-104 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-79521-154-104 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-79521-154-104 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-79521-154-104 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-79521-154-104 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-31763">
    #headline-31763 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="button_style_tmp_orb-75913">
    #tmp_orb-75913 .elButtonFlat:hover {
      background-color: #98eab0 !important;
    }

    #tmp_orb-75913 .elButtonBottomBorder:hover {
      background-color: #98eab0 !important;
    }

    #tmp_orb-75913 .elButtonSubtle:hover {
      background-color: #98eab0 !important;
    }

    #tmp_orb-75913 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(186, 241, 202)), color-stop(1, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -ms-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: linear-gradient(to bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
    }

    #tmp_orb-75913 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -ms-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: linear-gradient(to bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
    }

    #tmp_orb-75913 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(186, 241, 202)), color-stop(1, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: -ms-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: linear-gradient(to bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
    }

    #tmp_orb-75913 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -ms-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: linear-gradient(to bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
    }

    #tmp_orb-75913 .elButtonBorder {
      border: 3px solid rgb(186, 241, 202) !important;
      color: rgb(186, 241, 202) !important;
    }

    #tmp_orb-75913 .elButtonBorder:hover {
      background-color: rgb(186, 241, 202) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_tmp_order2stepi-58237">
    #tmp_order2stepi-58237 .elButtonFlat:hover {
      background-color: #45a03e !important;
    }

    #tmp_order2stepi-58237 .elButtonBottomBorder:hover {
      background-color: #45a03e !important;
    }

    #tmp_order2stepi-58237 .elButtonSubtle:hover {
      background-color: #45a03e !important;
    }

    #tmp_order2stepi-58237 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(85, 186, 77)), color-stop(1, #45a03e));
      background-image: -o-linear-gradient(bottom, rgb(85, 186, 77) 0%, #45a03e 100%);
      background-image: -moz-linear-gradient(bottom, rgb(85, 186, 77) 0%, #45a03e 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(85, 186, 77) 0%, #45a03e 100%);
      background-image: -ms-linear-gradient(bottom, rgb(85, 186, 77) 0%, #45a03e 100%);
      background-image: linear-gradient(to bottom, rgb(85, 186, 77) 0%, #45a03e 100%);
    }

    #tmp_order2stepi-58237 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(85, 186, 77)), color-stop(0, #45a03e));
      background-image: -o-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 0%);
      background-image: -moz-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 0%);
      background-image: -ms-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 0%);
      background-image: linear-gradient(to bottom, rgb(85, 186, 77) 100%, #45a03e 0%);
    }

    #tmp_order2stepi-58237 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(85, 186, 77)), color-stop(1, #45a03e));
      background-image: -o-linear-gradient(bottom, rgb(85, 186, 77) 30%, #45a03e 80%);
      background-image: -moz-linear-gradient(bottom, rgb(85, 186, 77) 30%, #45a03e 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(85, 186, 77) 30%, #45a03e 80%);
      background-image: -ms-linear-gradient(bottom, rgb(85, 186, 77) 30%, #45a03e 80%);
      background-image: linear-gradient(to bottom, rgb(85, 186, 77) 30%, #45a03e 80%);
    }

    #tmp_order2stepi-58237 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(85, 186, 77)), color-stop(0, #45a03e));
      background-image: -o-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 30%);
      background-image: -moz-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 30%);
      background-image: -ms-linear-gradient(bottom, rgb(85, 186, 77) 100%, #45a03e 30%);
      background-image: linear-gradient(to bottom, rgb(85, 186, 77) 100%, #45a03e 30%);
    }

    #tmp_order2stepi-58237 .elButtonBorder {
      border: 3px solid rgb(85, 186, 77) !important;
      color: rgb(85, 186, 77) !important;
    }

    #tmp_order2stepi-58237 .elButtonBorder:hover {
      background-color: rgb(85, 186, 77) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-47068">
    #headline-47068 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-86010">
    #headline-86010 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-84106">
    #headline-84106 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-84106-180">
    #headline-84106-180 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-67150">
    #headline-67150 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_button-60555-130">
    #button-60555-130 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-60555-130 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-60555-130 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-60555-130 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-60555-130 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-60555-130 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #button-60555-130 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-60555-130 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-60555-130 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-38323-173">
    #headline-38323-173 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="bold_style_headline-58724-122">
    #headline-58724-122 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="bold_style_headline-84106-122">
    #headline-84106-122 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-57311-106">
    #headline-57311-106 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-21503">
    #headline-21503 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-31763-136">
    #headline-31763-136 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-26566-146">
    #headline-26566-146 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-82656">
    #headline-82656 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-71668">
    #headline-71668 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-60726">
    #headline-60726 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-51545">
    #headline-51545 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-79795">
    #headline-79795 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-39820">
    #headline-39820 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-21790">
    #headline-21790 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-96507">
    #headline-96507 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-17555">
    #headline-17555 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-61546">
    #headline-61546 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-31763-144">
    #headline-31763-144 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-26566-147">
    #headline-26566-147 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-85190-186">
    #headline-85190-186 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-44605">
    #headline-44605 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-36077">
    #headline-36077 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-12828">
    #headline-12828 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-34907">
    #headline-34907 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-22307">
    #headline-22307 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-36885">
    #headline-36885 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-79795-138">
    #headline-79795-138 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-86729">
    #headline-86729 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-51129">
    #headline-51129 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-40581">
    #headline-40581 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-51342">
    #headline-51342 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-43138">
    #headline-43138 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-93609">
    #headline-93609 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-75305">
    #headline-75305 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-80299">
    #headline-80299 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-16637">
    #headline-16637 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-44605-143">
    #headline-44605-143 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-36077-169">
    #headline-36077-169 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-12828-144">
    #headline-12828-144 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-34907-131">
    #headline-34907-131 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-22307-103">
    #headline-22307-103 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-58768-143">
    #headline-58768-143 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-91486">
    #headline-91486 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-45704">
    #headline-45704 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-66752">
    #headline-66752 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-89404">
    #headline-89404 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-91807">
    #headline-91807 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-16041">
    #headline-16041 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-89278">
    #headline-89278 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-40194">
    #headline-40194 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="button_style_headline-40194">
    #headline-40194 .elButtonFlat:hover {
      background-color: #191919 !important;
    }

    #headline-40194 .elButtonBottomBorder:hover {
      background-color: #191919 !important;
    }

    #headline-40194 .elButtonSubtle:hover {
      background-color: #191919 !important;
    }

    #headline-40194 .elButtonGradient {
    ...
    #headline-40194 .elButtonGradient:hover {
    ...
    #headline-40194 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(45, 45, 45)), color-stop(1, #191919));
    ...
    #headline-40194 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(45, 45, 45)), color-stop(0, #191919));
    ...
    #headline-40194 .elButtonBorder {
      border: 3px solid rgb(45, 45, 45) !important;
      color: rgb(45, 45, 45) !important;
    }

    #headline-40194 .elButtonBorder:hover {
      background-color: rgb(45, 45, 45) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-65412">
    #headline-65412 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="bold_style_headline-56483">
    #headline-56483 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="bold_style_headline-80341">
    #headline-80341 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-46397">
    #headline-46397 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-66781">
    #headline-66781 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-21790-152">
    #headline-21790-152 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-39820-134">
    #headline-39820-134 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-39820-134-170">
    #headline-39820-134-170 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-21790-152-161">
    #headline-21790-152-161 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-79795-138-134">
    #headline-79795-138-134 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-39981">
    #headline-39981 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-24701">
    #headline-24701 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-72831">
    #headline-72831 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-85365">
    #headline-85365 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-78594">
    #headline-78594 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_button-25187">
    #button-25187 .elButtonFlat:hover {
      background-color: #98eab0 !important;
    }

    #button-25187 .elButtonBottomBorder:hover {
      background-color: #98eab0 !important;
    }

    #button-25187 .elButtonSubtle:hover {
      background-color: #98eab0 !important;
    }

    #button-25187 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(186, 241, 202)), color-stop(1, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
    ...
    #button-25187 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
    ...
    #button-25187 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
    ...
    #button-25187 .elButtonBorder {
      border: 3px solid rgb(186, 241, 202) !important;
      color: rgb(186, 241, 202) !important;
    }

    #button-25187 .elButtonBorder:hover {
      background-color: rgb(186, 241, 202) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_button-63787">
    #button-63787 .elButtonFlat:hover {
      background-color: #c42719 !important;
    }

    #button-63787 .elButtonBottomBorder:hover {
      background-color: #c42719 !important;
    }

    #button-63787 .elButtonSubtle:hover {
      background-color: #c42719 !important;
    }

    #button-63787 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(228, 59, 44, 0.73)), color-stop(1, #c42719));
      background-image: -o-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 0%, #c42719 100%);
      background-image: -moz-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 0%, #c42719 100%);
      background-image: -webkit-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 0%, #c42719 100%);
      background-image: -ms-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 0%, #c42719 100%);
      background-image: linear-gradient(to bottom, rgba(228, 59, 44, 0.73) 0%, #c42719 100%);
    }

    #button-63787 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgba(228, 59, 44, 0.73)), color-stop(0, #c42719));
      background-image: -o-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 100%, #c42719 0%);
      background-image: -moz-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 100%, #c42719 0%);
      background-image: -webkit-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 100%, #c42719 0%);
      background-image: -ms-linear-gradient(bottom, rgba(228, 59, 44, 0.73) 100%, #c42719 0%);
      background-image: linear-gradient(to bottom, rgba(228, 59, 44, 0.73) 100%, #c42719 0%);
    }

    #button-63787 .elButtonBorder {
      border: 3px solid rgba(228, 59, 44, 0.73) !important;
      color: rgba(228, 59, 44, 0.73) !important;
    }

    #button-63787 .elButtonBorder:hover {
      background-color: rgba(228, 59, 44, 0.73) !important;
      color: #000 !important;
    }
  </style>
  <style id="button_style_button-95661">
    #button-95661 .elButtonFlat:hover {
      background-color: #cd291a !important;
    }

    #button-95661 .elButtonBottomBorder:hover {
      background-color: #cd291a !important;
    }

    #button-95661 .elButtonSubtle:hover {
      background-color: #cd291a !important;
    }

    #button-95661 .elButtonGradient {
    ...
    #button-95661 .elButtonGradient:hover {
    ...
    #button-95661 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(228, 59, 44)), color-stop(1, #cd291a));
    ...
    #button-95661 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(228, 59, 44)), color-stop(0, #cd291a));
    ...
    #button-95661 .elButtonBorder {
      border: 3px solid rgb(228, 59, 44) !important;
      color: rgb(228, 59, 44) !important;
    }

    #button-95661 .elButtonBorder:hover {
      background-color: rgb(228, 59, 44) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_tmp_button-79683">
    #tmp_button-79683 .elButtonFlat:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683 .elButtonBottomBorder:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683 .elButtonSubtle:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683 .elButtonGradient {
    ...
    #tmp_button-79683 .elButtonGradient:hover {
    ...
    #tmp_button-79683 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(0, 0, 0, 0)), color-stop(1, #000000));
    ...
    #tmp_button-79683 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgba(0, 0, 0, 0)), color-stop(0, #000000));
    ...
    #tmp_button-79683 .elButtonBorder {
      border: 3px solid rgba(0, 0, 0, 0) !important;
      color: rgba(0, 0, 0, 0) !important;
    }

    #tmp_button-79683 .elButtonBorder:hover {
      background-color: rgba(0, 0, 0, 0) !important;
      color: #000 !important;
    }
  </style>
  <style id="button_style_tmp_button-79683-180">
    #tmp_button-79683-180 .elButtonFlat:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683-180 .elButtonBottomBorder:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683-180 .elButtonSubtle:hover {
      background-color: #000000 !important;
    }

    #tmp_button-79683-180 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(0, 0, 0, 0)), color-stop(1, #000000));
      background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, #000000 100%);
      background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, #000000 100%);
      background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0) 0%, #000000 100%);
    ...
    #tmp_button-79683-180 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgba(0, 0, 0, 0)), color-stop(0, #000000));
      background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 0%);
      background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 0%);
      background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 0%);
    ...
    #tmp_button-79683-180 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(0, 0, 0, 0)), color-stop(1, #000000));
      background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0) 30%, #000000 80%);
      background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0) 30%, #000000 80%);
      background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0) 30%, #000000 80%);
    ...
    #tmp_button-79683-180 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgba(0, 0, 0, 0)), color-stop(0, #000000));
      background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 30%);
      background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 30%);
      background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0) 100%, #000000 30%);
    ...
    #tmp_button-79683-180 .elButtonBorder {
      border: 3px solid rgba(0, 0, 0, 0) !important;
      color: rgba(0, 0, 0, 0) !important;
    }

    #tmp_button-79683-180 .elButtonBorder:hover {
      background-color: rgba(0, 0, 0, 0) !important;
      color: #000 !important;
    }
  </style>
  <style id="button_style_button-25187-173">
    #button-25187-173 .elButtonFlat:hover {
      background-color: #98eab0 !important;
    }

    #button-25187-173 .elButtonBottomBorder:hover {
      background-color: #98eab0 !important;
    }

    #button-25187-173 .elButtonSubtle:hover {
      background-color: #98eab0 !important;
    }

    #button-25187-173 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(186, 241, 202)), color-stop(1, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 0%, #98eab0 100%);
    ...
    #button-25187-173 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 0%);
    ...
    #button-25187-173 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(186, 241, 202)), color-stop(1, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 30%, #98eab0 80%);
    ...
    #button-25187-173 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(186, 241, 202)), color-stop(0, #98eab0));
      background-image: -o-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -moz-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(186, 241, 202) 100%, #98eab0 30%);
    ...
    #button-25187-173 .elButtonBorder {
      border: 3px solid rgb(186, 241, 202) !important;
      color: rgb(186, 241, 202) !important;
    }

    #button-25187-173 .elButtonBorder:hover {
      background-color: rgb(186, 241, 202) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_headline-10024">
    #headline-10024 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #headline-10024 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #headline-10024 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }
    ...
    #headline-10024 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #headline-10024 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #headline-10024 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #headline-10024 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #headline-10024 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-16332">
    #headline-16332 .elHeadline b {
      color: rgb(71, 71, 71);
    }
  </style>
  <style id="bold_style_headline-17470">
    #headline-17470 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_tmp_headline1-29029">
    #tmp_headline1-29029 .elHeadline b {
      color: rgb(228, 59, 44);
    }
  </style>
  <style id="bold_style_headline-91347">
    #headline-91347 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-57311-115">
    #headline-57311-115 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-70395-187">
    #headline-70395-187 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-47363-122">
    #headline-47363-122 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-57363-152">
    #headline-57363-152 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-61027-132">
    #headline-61027-132 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-51931-128">
    #headline-51931-128 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-16579-184">
    #headline-16579-184 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-55431-166">
    #headline-55431-166 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-96833-147">
    #headline-96833-147 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-45986-130">
    #headline-45986-130 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-48774-154">
    #headline-48774-154 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-90105-100">
    #headline-90105-100 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-95335-171">
    #headline-95335-171 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-50701-101">
    #headline-50701-101 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-36839-121">
    #headline-36839-121 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-93747-188">
    #headline-93747-188 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-66261-124">
    #headline-66261-124 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-67175-187">
    #headline-67175-187 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-46658-118">
    #headline-46658-118 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  ...
  <style id="bold_style_headline-96003-141">
    #headline-96003-141 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-60726-138">
    #headline-60726-138 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-51545-164">
    #headline-51545-164 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-21380">
    #headline-21380 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-50043-155-107">
    #headline-50043-155-107 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-51824-144">
    #headline-51824-144 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-26566-155">
    #headline-26566-155 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-73997-120">
    #headline-73997-120 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-49353-185">
    #headline-49353-185 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-33151-178">
    #headline-33151-178 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-55072-148">
    #headline-55072-148 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  ...
  <style id="bold_style_headline-78728-114">
    #headline-78728-114 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  ...
  <style id="bold_style_headline-17685-117">
    #headline-17685-117 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  ...
  <style id="bold_style_headline-79795-138-134-131">
    #headline-79795-138-134-131 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-21790-152-161-142">
    #headline-21790-152-161-142 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-24701-165">
    #headline-24701-165 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-39981-188">
    #headline-39981-188 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-79795-138-134-149">
    #headline-79795-138-134-149 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-21790-152-161-120">
    #headline-21790-152-161-120 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-39981-125">
    #headline-39981-125 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="bold_style_headline-91886-185">
    #headline-91886-185 .elHeadline b {
      color: rgb(0, 189, 57);
    }
  </style>
  <style id="bold_style_headline-38987-185">
    #headline-38987-185 .elHeadline b {
      color: rgb(255, 255, 255);
    }
  </style>
  <style id="button_style_button-48406-157">
    #button-48406-157 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-48406-157 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-48406-157 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-48406-157 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-48406-157 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-48406-157 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #button-48406-157 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-48406-157 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-48406-157 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_button-35684">
    #button-35684 .elButtonFlat:hover {
      background-color: #00942d !important;
    }

    #button-35684 .elButtonBottomBorder:hover {
      background-color: #00942d !important;
    }

    #button-35684 .elButtonSubtle:hover {
      background-color: #00942d !important;
    }

    #button-35684 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 0%, #00942d 100%);
    ...
    #button-35684 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 0%);
    ...
    #button-35684 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(0, 189, 57)), color-stop(1, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 30%, #00942d 80%);
    ...
    #button-35684 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(0, 189, 57)), color-stop(0, #00942d));
      background-image: -o-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -moz-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(0, 189, 57) 100%, #00942d 30%);
    ...
    #button-35684 .elButtonBorder {
      border: 3px solid rgb(0, 189, 57) !important;
      color: rgb(0, 189, 57) !important;
    }

    #button-35684 .elButtonBorder:hover {
      background-color: rgb(0, 189, 57) !important;
      color: #FFF !important;
    }
  </style>
  <style id="button_style_button-69425">
    #button-69425 .elButtonFlat:hover {
      background-color: #0867f4 !important;
    }

    #button-69425 .elButtonBottomBorder:hover {
      background-color: #0867f4 !important;
    }

    #button-69425 .elButtonSubtle:hover {
      background-color: #0867f4 !important;
    }

    #button-69425 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(45, 127, 248)), color-stop(1, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: -ms-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: linear-gradient(to bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
    }

    #button-69425 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(45, 127, 248)), color-stop(0, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: -ms-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: linear-gradient(to bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
    }

    #button-69425 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(45, 127, 248)), color-stop(1, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: -ms-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: linear-gradient(to bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
    }

    #button-69425 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(45, 127, 248)), color-stop(0, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: -ms-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: linear-gradient(to bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
    }

    #button-69425 .elButtonBorder {
      border: 3px solid rgb(45, 127, 248) !important;
      color: rgb(45, 127, 248) !important;
    }

    #button-69425 .elButtonBorder:hover {
      background-color: rgb(45, 127, 248) !important;
      color: #FFF !important;
    }
  </style>
  <style id="bold_style_headline-45511">
    #headline-45511 .elHeadline b {
      color: rgb(45, 45, 45);
    }
  </style>
  <style id="button_style_tmp_button-24234">
    #tmp_button-24234 .elButtonFlat:hover {
      background-color: #0867f4 !important;
    }

    #tmp_button-24234 .elButtonBottomBorder:hover {
      background-color: #0867f4 !important;
    }

    #tmp_button-24234 .elButtonSubtle:hover {
      background-color: #0867f4 !important;
    }

    #tmp_button-24234 .elButtonGradient {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(45, 127, 248)), color-stop(1, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 0%, #0867f4 100%);
    ...
    #tmp_button-24234 .elButtonGradient:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(45, 127, 248)), color-stop(0, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 0%);
    ...
    #tmp_button-24234 .elButtonGradient2 {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgb(45, 127, 248)), color-stop(1, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 30%, #0867f4 80%);
    ...
    #tmp_button-24234 .elButtonGradient2:hover {
      background-image: -webkit-gradient(linear, left top, left bottom, color-stop(1, rgb(45, 127, 248)), color-stop(0, #0867f4));
      background-image: -o-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: -moz-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
      background-image: -webkit-linear-gradient(bottom, rgb(45, 127, 248) 100%, #0867f4 30%);
    ...
    #tmp_button-24234 .elButtonBorder {
      border: 3px solid rgb(45, 127, 248) !important;
      color: rgb(45, 127, 248) !important;
    }

    #tmp_button-24234 .elButtonBorder:hover {
      background-color: rgb(45, 127, 248) !important;
      color: #FFF !important;
    }
  </style>
...
<style id="custom-css">
  ...
  .trust-seals .seal .seal-icon,
  .trust-seals .seal .seal-text {
    display: flex;
  }
  ...
  @media only screen and (max-width: 770px) {
    [data-title='theStackReplacer'] .elHeadline {
      text-align: center !important;
    }

    [data-title='theStackReplacer'] .col_right {
      margin-top: 5px !important;
      margin-bottom: 15px;
    }

    [data-title='featured'] .col-md-2 {
      float: left;
      width: 50%;
    }

    [data-title='featured'] .col_right {
    ...
    [data-title*='faux-bump-row-1'] #col-left-102,
    [data-title*='faux-bump-row-2'] #col-left-102-174 {
      float: left;
    }

    #tmp_image-50710 img,
    #tmp_image-50710-180 img {
      width: 40px !important;
      height: auto;
    }

    [data-title*='faux-bump-row-1'] #col-center-135,
    [data-title*='faux-bump-row-2'] #col-center-135-164 {
      margin-left: 50px !important;
      margin-top: 0 !important;
    }

    #tmp_subheadline-40510 h2,
    tmp_subheadline-40510-116 h2 {
      font-size: 16px !important;
    }

    #headline-29254 h2,
    #headline-29254-131 h2 {
      font-size: 18px !important;
    }

    #tmp_paragraph-43585 .elHeadline,
    tmp_paragraph-43585-145 .elHeadline {
      font-size: 14px;
    }

    #tmp_button-79683,
    #tmp_button-79683-180 {
      margin: auto;
      margin-top: 15px;
    }
  }
